...
; Genere YGNT_Manager_Setup_1.0.2.exe a partir du build PyInstaller
...
;   2) ISCC ygnt_manager_setup.iss                 (produit installer\YGNT_Manager_Setup_1.0.2.exe)
...
; Details de YGNT_Manager_Setup_1.0.2.exe) - independante de AppVersion, qui
...
OutputDir=installer
OutputBaseFilename=YGNT_Manager_Setup_1.0.2
Compression=lzma2
