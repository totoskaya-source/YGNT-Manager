...
class DevisGenerator:
    ...
    def generate(self, devis, output_path):
        from docx import Document

        doc = Document(self.template_path)
        values = devis.to_dict()

        PlaceholderEngine.replace_in_document(doc, values)
        self._insert_logo(doc, getattr(devis, "producteur_logo_path", ""))
    ...
    def _insert_logo(self, doc, logo_path):
        ...
        chemin provient exclusivement de l'instantane stocke dans le Devis,
